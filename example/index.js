...
crispy.set_command('kick', cmds.kick_command, 'kick <users|words> <targets> - Add users or words to the kicked list.')
crispy.set_command('unkick', cmds.unkick_command, 'unkick <users|words> <targets> - Remove users or words from the kicked list.')
...
crispy.set_command('kicked', cmds.kicked_command, 'kicked <users|words> - Private messages the kicked users/words list.')
